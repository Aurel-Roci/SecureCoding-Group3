...
\begin{tabular}{ l|p{11cm}  }
	...
	\multicolumn{2}{c}{\textbf{Team2}} \\
	\hline
	Observation   & We did not find any vulnerability regarding code injection and local or remote file inclusion in our web app. Team 2 we were able to upload a file with code but there was no abnormal behavior of the web app. \\
