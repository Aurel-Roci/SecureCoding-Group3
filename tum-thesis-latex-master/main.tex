...
\begin{tabular}{cc}
	\textbf{Secode21} \hspace{9cm} & \begin{tabular}{@{}c@{}c@{}}Likelihood: 10\\ Impact: 4\\ Risk:4 \end{tabular}
\end{tabular}\
...
\begin{tabular}{cc}
	\textbf{Secode21} \hspace{9cm} & \begin{tabular}{@{}c@{}c@{}}Likelihood: 5\\ Impact: 5\\ Risk: 5 \end{tabular}
\end{tabular}\
...
\begin{tabular}{ l|p{11cm}  }
	...
	\multicolumn{2}{c}{\textbf{Secode21}} \\
	\hline
	Observation   & The session id is not invalidated and therfore does not change after the user is authenticated. This means
